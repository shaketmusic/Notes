...
- [Motherboard – Reed Ghazala, the Father of Circuit Bending: Sound Builders](https://www.youtube.com/watch?v=KHDL9iGxDPM&ab_channel=Motherboard)
- [gearwire – Circuit Bending with Reed Ghazala](https://www.youtube.com/watch?v=Wy1mdLpy0SY&ab_channel=gearwire)

## Tutorials

- [Anti-Theory – A Bender’s Guide (Tutorial)](http://www.anti-theory.com/soundart/circuitbend/cb01.html)

# Misc.

- Makezine – Add Volume, Jack
    - [Link](https://makezine.com/projects/add-volume-jack/)
    - PDF
        
        [Add Volume, Jack - Make:.pdf](Add_Volume_Jack_-_Make.pdf)
        
- Instructables – Wire a Potentiometer as a Variable Resistor
    
    [Wire-a-Potentiometer-as-a-Variable-Resistor.pdf](Wire-a-Potentiometer-as-a-Variable-Resistor.pdf)
    
- Pinouts – Wiring Audio Jacks
    - TS and TRS Female
        - The inner contact is Ground for both Mono and Stereo.
            
            ![Untitled](Containers/Resources%20Page/Circuit%20Bending%20Resources/Untitled.png)
            
        - Note that some devices might have a longer inner lead, which also corresponds to Ground.
            
            ![Untitled](Containers/Resources%20Page/Circuit%20Bending%20Resources/Untitled%201.png)
            
    - TS Male
        
        ![TS_Male.png](TS_Male.png)
        
    - TRS Male
        
        ![TRS_Male.png](TRS_Male.png)